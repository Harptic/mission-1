...
public class DBConnection {
  ...
  final String dbFilePath = "C:\\Users\\User\\Desktop\\zerobase\\dev\\workspace\\zerobase-mission1\\wifi.db";
  ...
  public List<BookmarkResponse> WifiMarkListDB() {
    ...
    try {
      ...
      while (rs.next()){
        list.add(BookmarkResponse.builder()
